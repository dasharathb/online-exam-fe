...
.controller('bankCntrl',['$scope','bankPaperFact','$routeParams',
	function($scope,bankPaperFact,$routeParams){
		$scope.count=1;
		$scope.questions=[];
      ...
      $scope.submit=function(){
      	...
      	$('#confirmModal').modal('hide');
      	bankPaperFact.saveBankPaper(questionPaper).then(function(data){
