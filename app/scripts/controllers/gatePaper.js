...
.controller('gateCntrl',['$scope','gatePaperFact','$routeParams',
	function($scope,gatePaperFact,$routeParams){
		$scope.count=1;
		$scope.questions=[];
      ...
      $scope.submit=function(){
      	...
      	$('#confirmModal').modal('hide');
      	gatePaperFact.saveGatePaper(questionPaper).then(function(data){
